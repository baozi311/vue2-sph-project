          ...
          <div class="choose">
            ...
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd
                  @click="
                    changeDefault(saleAttr.spuSaleAttrValueList, saleAttrValue)
                  "
                  changepirce="0"
            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  ...
                  class="itxt"
                  v-model="skuNum"
                  @change="skuNum = Math.ceil(skuNum > 1 ? skuNum : 1)"
                />
...
export default {
  ...
  methods: {
    ...
    // 排他思想
    changeDefault(spuSaleAttrValueList, saleAttrValue) {
